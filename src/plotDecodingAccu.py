...
plt.xlim([-0.5,5])
plt.ylim([0,1.])
plt.title("Within-Modality Decoding\nSub-002, Features = 363, smoothing = 0, b-maps")
plt.legend()
#plt.show()
plt.savefig('/Users/shahzad/Files/fMRI/TacMotionAnalysis/derivatives/cosmoMvpa/2mmvoxel/Sub-002_WithinModalityDecoding_Features363_smoothing0_bmaps.png')
